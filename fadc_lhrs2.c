/*************************************************************************
 *
 *  fadc_lhrs2.c - Readout VXS crate on LHRS.
 *          originally from ti_master_list.c
 *                  Library of routines for readout and buffering of
...
TI_SLAVE_CONFIG tiSlaveConfig = {0,0,0};
...
/*      tiSetTriggerSource(TI_TRIGGER_TSINPUTS); TS Inputs enabled */
  ...
  printf("lololol rocDownload: User Download Executed\n");
