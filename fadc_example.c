/*************************************************************************
 *
 *  fadc_example.c - Library of routines for config and readout of
 *                    fadc250s, using a JLab pipeline TI
 *                    as a source for trigger and syncreset.
 *
 *   build with
 *    make -B fadc_example.so fadc_slave5_example.so
 *
...
/*
  Local Variables:
  compile-command: "make -B fadc_example.so fadc_slave5_example.so"
  End:
 */
